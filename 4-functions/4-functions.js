...
function actionCorrect(subject){
...
function actionInCorrect(subject){
...
function submitEnglishAns() {
  ...
  if (answer === "website") {
    // correct
    actionCorrect(`english`);
  } else {
    // incorrect
    actionInCorrect(`english`);
  }
}
...
function submitScienceAns() {
  ...
  if (answer.toLowerCase() === "blue") {
    // correct
    actionCorrect(`science`);
  } else {
    // incorrect
    actionInCorrect(`science`);
  }
}